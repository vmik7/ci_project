...
const block = cn('start')

export interface StartProps extends BasePageProps {}

export const Start = memo<StartProps>((props) => {
    ...
    return (
        <>
            ...
            />
            <div className={block(null, [contentClass])} data-testid="start">
